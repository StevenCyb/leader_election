...
func (x *VoteMessage) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *VoteMessage) GetTerm() uint64 {
	if x != nil {
		return x.Term
	}
	return 0
...
func (x *VoteResponse) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *HeartbeatMessage) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *HeartbeatMessage) GetTerm() uint64 {
	if x != nil {
		return x.Term
	}
	return 0
...
var file_raft_proto_rawDesc = []byte{
	...
	0x33, 0x0a, 0x0b, 0x56, 0x6f, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10,
	...
	,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x17, 0x5a, 0x15, 0x70, 0x6b, 0x67, 0x2f, 0x72,
	0x61, 0x66, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x72, 0x70, 0x63,
...
var file_raft_proto_goTypes = []any{
	(*VoteMessage)(nil),      // 0: raft.VoteMessage
	(*VoteResponse)(nil),     // 1: raft.VoteResponse
	(*HeartbeatMessage)(nil), // 2: raft.HeartbeatMessage
	(*emptypb.Empty)(nil),    // 3: google.protobuf.Empty
}
var file_raft_proto_depIdxs = []int32{
	0, // 0: raft.RaftService.RequestVote:input_type -> raft.VoteMessage
	2, // 1: raft.RaftService.Heartbeat:input_type -> raft.HeartbeatMessage
	1, // 2: raft.RaftService.RequestVote:output_type -> raft.VoteResponse
	3, // 3: raft.RaftService.Heartbeat:output_type -> google.protobuf.Empty
