...
func TestClientServer(t *testing.T) {
	...
	s.OnElection(func(ctx context.Context) (*emptypb.Empty, error) {
		require.NotNil(t, ctx)
		return &emptypb.Empty{}, nil
	})
	s.OnLeaderAnnouncement(func(ctx context.Context, lam *pb.LeaderAnnouncementMessage) (*emptypb.Empty, error) {
	...
	for i := 0; i < 10; i++ {
		...
		require.NoError(t, c.Elect(context.Background()))
		require.NoError(t, c.LeaderAnnouncement(context.Background(), &pb.LeaderAnnouncementMessage{}))
	}
}
